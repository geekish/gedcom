...
class Gedcom
{
     ...
     *
     * @var \Geekish\Gedcom\Record\Head
     */
    protected $head;
     ...
     *
     * @var \Geekish\Gedcom\Record\Subn
     */
    protected $subn;
     ...
     *
     * @var \Geekish\Gedcom\Record\Sour[]
     */
    protected $sour = [];
     ...
     *
     * @var \Geekish\Gedcom\Record\Indi[]
     */
    protected $indi = [];
     ...
     *
     * @var \Geekish\Gedcom\Record\Note[]
     */
    protected $note = [];
     ...
     *
     * @var \Geekish\Gedcom\Record\Repo[]
     */
    protected $repo = [];
     ...
     *
     * @var \Geekish\Gedcom\Record\Obje[]
     */
    protected $obje = [];
     ...
     *
     * @var \Geekish\Gedcom\Record\Subm[]
     */
    protected $subm = [];
     ...
     */
    public function setHead(\Geekish\Gedcom\Record\Head $head)
    {
        $this->head = $head;
    }
     ...
     */
    public function setSubn(\Geekish\Gedcom\Record\Subn $subn)
    {
        $this->subn = $subn;
    }
     ...
     */
    public function addSour(\Geekish\Gedcom\Record\Sour $sour)
    {
     ...
     */
    public function addIndi(\Geekish\Gedcom\Record\Indi $indi)
    {
     ...
     */
    public function addFam(\Geekish\Gedcom\Record\Fam $fam)
    {
     ...
     */
    public function addNote(\Geekish\Gedcom\Record\Note $note)
    {
     ...
     */
    public function addRepo(\Geekish\Gedcom\Record\Repo $repo)
    {
     ...
     */
    public function addObje(\Geekish\Gedcom\Record\Obje $obje)
    {
     ...
     */
    public function addSubm(\Geekish\Gedcom\Record\Subm $subm)
    {
     ...
     *
     * @return \Geekish\Gedcom\Record\Subn
     */
     ...
     *
     * @return \Geekish\Gedcom\Record\Subm[]
     */
     ...
     *
     * @return \Geekish\Gedcom\Record\Indi[]
     */
     ...
     *
     * @return \Geekish\Gedcom\Record\Fam[]
     */
     ...
     *
     * @return \Geekish\Gedcom\Record\Sour[]
     */
     ...
     *
     * @return \Geekish\Gedcom\Record\Note[]
     */
     ...
     *
     * @return \Geekish\Gedcom\Record\Obje[]
     */
